...
import java.util.*;
import java.io.*;
public class InvokeEJBRevChainCrSubJavaCode{
...
/****** END SET/GET METHOD, DO NOT MODIFY *****/
	public InvokeEJBRevChainCrSubJavaCode() {
	}
	public InvokeEJBRevChainCrSubJavaCode(String factory, String contextURL, String jNDIName, String userName,
		String password, String inputXMLString, String outputXMLString) {
	super();
	Factory = factory;
	...
	OutputXMLString = outputXMLString;
	System.out.println(inputXMLString);
}
	public void invoke() throws Exception {
/* Available Variables: DO NOT MODIFY
	In  : String Factory
	In  : String ContextURL
	In  : String JNDIName
	In  : String UserName
	In  : String Password
	In  : String InputXMLString
	Out : String OutputXMLString
* Available Variables: DO NOT MODIFY *****/
...
if (getUserName() != null && !getUserName().trim().equals("") && getPassword() != null && !getPassword().trim().equals("")) {
...
//createSubscriberHome = (com.daleen.process.CreateSubscriber.CreateSubscriberXMLHome) context.lookup(getJNDIName());
